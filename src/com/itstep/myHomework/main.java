...
import com.itstep.Lesson8.Address;
import com.itstep.Lesson8.Item;
import com.itstep.Lesson8.Order;
import com.itstep.Lesson8.Type;
import com.itstep.Lesson8.User;
...
//                user1.userAddresses.get("HOME").getFullAddress());//has address
        ...
        Item babyDoll=new Item("Baby Doll", com.itstep.Lesson8.Type.TOYS);
        order1Items.add(babyDoll);

        Item car=new Item("Car", com.itstep.Lesson8.Type.TOYS);
        order1Items.add(car);

        Item tShirt=new Item("T-Shirt", com.itstep.Lesson8.Type.CLOTHES);
   ...
   // AdminUser adminUser=new AdminUser("adminusername@gmail.com");
   // User user = new User("today@gmail.com");

   // adminUser.rejectOrder(new UserOrder(user, new ArrayList<>()));
}
}